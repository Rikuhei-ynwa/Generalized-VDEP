"""SPADL schema for RDD data."""
from typing import Optional

import pandera as pa
from pandera.typing import DateTime, Object, Series

from socceraction.data.schema import (CompetitionSchema, EventSchema,
                                      GameSchema, PlayerSchema, TeamSchema)


class RDDCompetitionSchema(CompetitionSchema):
...
class RDDGameSchema(GameSchema):
...
class RDDPlayerSchema(PlayerSchema):
